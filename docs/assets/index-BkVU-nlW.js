...
`)+`
`+p);const E=S+m+a,x=S+p+o,L=El(i,i.VERTEX_SHADER,E),w=El(i,i.FRAGMENT_SHADER,x);i.attachShader(_,L),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(R){if(r.debug.checkShaderErrors){const z=i.getProgramInfoLog(_).trim(),O=i.getShaderInfoLog(L).trim(),X=i.getShaderInfoLog(w).trim();let V=!0,W=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(V=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,L,w);else{const Y=wl(i,L,"vertex"),H=wl(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+Y+`
`+H)}else z!==""?console.warn("THREE.WebGLProgram: Program Info Log:",z):(O===""||X==="")&&(W=!1);W&&(R.diagnostics={runnable:V,programLog:z,vertexShader:{log:O,prefix:m},fragmentShader:{log:X,prefix:p}})}i.deleteShader(L),i.deleteShader(w),I=new ir(i,_),M=Nm(i,_)}let I;this.getUniforms=function(){return I===void 0&&A(this),I};let M;this.getAttributes=function(){return M===void 0&&A(this),M};let v=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return v===!1&&(v=i.getProgramParameter(_,wm)),v},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(_),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Am++,this.cacheKey=e,this.usedTimes=1,this.program=_,this.vertexShader=L,this.fragmentShader=w,this}let jm=0;class Ym{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),s=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(i)===!1&&(a.add(i),i.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Km(e),t.set(e,n)),n}}class Km{constructor(e){this.id=jm++,this.code=e,this.usedTimes=0}}function $m(r,e,t,n,i,s,a){const o=new ho,l=new Ym,c=new Set,h=[],u=i.logarithmicDepthBuffer,d=i.vertexTextures;let f=i.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(M){return c.add(M),M===0?"uv":`uv${M}`}function m(M,v,R,z,O){const X=z.fog,V=O.geometry,W=M.isMeshStandardMaterial?z.environment:null,Y=(M.isMeshStandardMaterial?t:e).get(M.envMap||W),H=Y&&Y.mapping===ur?Y.image.height:null,te=g[M.type];M.precision!==null&&(f=i.getMaxPrecision(M.precision),f!==M.precision&&console.warn("THREE.WebGLProgram.getParameters:",M.precision,"not supported, using",f,"instead."));const ce=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,_e=ce!==void 0?ce.length:0;let Ne=0;V.morphAttributes.position!==void 0&&(Ne=1),V.morphAttributes.normal!==void 0&&(Ne=2),V.morphAttributes.color!==void 0&&(Ne=3);let et,j,ee,ge;if(te){const $e=on[te];et=$e.vertexShader,j=$e.fragmentShader}else et=M.vertexShader,j=M.fragmentShader,l.update(M),ee=l.getVertexShaderID(M),ge=l.getFragmentShaderID(M);const se=r.getRenderTarget(),Te=r.state.buffers.depth.getReversed(),Ce=O.isInstancedMesh===!0,Fe=O.isBatchedMesh===!0,lt=!!M.map,Ve=!!M.matcap,ht=!!Y,N=!!M.aoMap,Vt=!!M.lightMap,ze=!!M.bumpMap,He=!!M.normalMap,Se=!!M.displacementMap,it=!!M.emissiveMap,be=!!M.metalnessMap,T=!!M.roughnessMap,y=M.anisotropy>0,F=M.clearcoat>0,K=M.dispersion>0,Z=M.iridescence>0,q=M.sheen>0,xe=M.transmission>0,re=y&&!!M.anisotropyMap,he=F&&!!M.clearcoatMap,We=F&&!!M.clearcoatNormalMap,J=F&&!!M.clearcoatRoughnessMap,ue=Z&&!!M.iridescenceMap,Ee=Z&&!!M.iridescenceThicknessMap,we=q&&!!M.sheenColorMap,de=q&&!!M.sheenRoughnessMap,Ge=!!M.specularMap,De=!!M.specularColorMap,tt=!!M.specularIntensityMap,P=xe&&!!M.transmissionMap,ie=xe&&!!M.thicknessMap,G=!!M.gradientMap,$=!!M.alphaMap,le=M.alphaTest>0,ae=!!M.alphaHash,Ie=!!M.extensions;let ct=Gn;M.toneMapped&&(se===null||se.isXRRenderTarget===!0)&&(ct=r.toneMapping);const Mt={shaderID:te,shaderType:M.type,shaderName:M.name,vertexShader:et,fragmentShader:j,defines:M.defines,customVertexShaderID:ee,customFragmentShaderID:ge,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:f,batching:Fe,batchingColor:Fe&&O._colorsTexture!==null,instancing:Ce,instancingColor:Ce&&O.instanceColor!==null,instancingMorph:Ce&&O.morphTexture!==null,supportsVertexTextures:d,outputColorSpace:se===null?r.outputColorSpace:se.isXRRenderTarget===!0?se.texture.colorSpace:Lt,alphaToCoverage:!!M.alphaToCoverage,map:lt,matcap:Ve,envMap:ht,envMapMode:ht&&Y.mapping,envMapCubeUVHeight:H,aoMap:N,lightMap:Vt,bumpMap:ze,normalMap:He,displacementMap:d&&Se,emissiveMap:it,normalMapObjectSpace:He&&M.normalMapType===Gh,normalMapTangentSpace:He&&M.normalMapType===dr,metalnessMap:be,roughnessMap:T,anisotropy:y,anisotropyMap:re,clearcoat:F,clearcoatMap:he,clearcoatNormalMap:We,clearcoatRoughnessMap:J,dispersion:K,iridescence:Z,iridescenceMap:ue,iridescenceThicknessMap:Ee,sheen:q,sheenColorMap:we,sheenRoughnessMap:de,specularMap:Ge,specularColorMap:De,specularIntensityMap:tt,transmission:xe,transmissionMap:P,thicknessMap:ie,gradientMap:G,opaque:M.transparent===!1&&M.blending===Ri&&M.alphaToCoverage===!1,alphaMap:$,alphaTest:le,alphaHash:ae,combine:M.combine,mapUv:lt&&_(M.map.channel),aoMapUv:N&&_(M.aoMap.channel),lightMapUv:Vt&&_(M.lightMap.channel),bumpMapUv:ze&&_(M.bumpMap.channel),normalMapUv:He&&_(M.normalMap.channel),displacementMapUv:Se&&_(M.displacementMap.channel),emissiveMapUv:it&&_(M.emissiveMap.channel),metalnessMapUv:be&&_(M.metalnessMap.channel),roughnessMapUv:T&&_(M.roughnessMap.channel),anisotropyMapUv:re&&_(M.anisotropyMap.channel),clearcoatMapUv:he&&_(M.clearcoatMap.channel),clearcoatNormalMapUv:We&&_(M.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:J&&_(M.clearcoatRoughnessMap.channel),iridescenceMapUv:ue&&_(M.iridescenceMap.channel),iridescenceThicknessMapUv:Ee&&_(M.iridescenceThicknessMap.channel),sheenColorMapUv:we&&_(M.sheenColorMap.channel),sheenRoughnessMapUv:de&&_(M.sheenRoughnessMap.channel),specularMapUv:Ge&&_(M.specularMap.channel),specularColorMapUv:De&&_(M.specularColorMap.channel),specularIntensityMapUv:tt&&_(M.specularIntensityMap.channel),transmissionMapUv:P&&_(M.transmissionMap.channel),thicknessMapUv:ie&&_(M.thicknessMap.channel),alphaMapUv:$&&_(M.alphaMap.channel),vertexTangents:!!V.attributes.tangent&&(He||y),vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!V.attributes.uv&&(lt||$),fog:!!X,useFog:M.fog===!0,fogExp2:!!X&&X.isFogExp2,flatShading:M.flatShading===!0,sizeAttenuation:M.sizeAttenuation===!0,logarithmicDepthBuffer:u,reverseDepthBuffer:Te,skinning:O.isSkinnedMesh===!0,morphTargets:V.morphAttributes.position!==void 0,morphNormals:V.morphAttributes.normal!==void 0,morphColors:V.morphAttributes.color!==void 0,morphTargetsCount:_e,morphTextureStride:Ne,numDirLights:v.directional.length,numPointLights:v.point.length,numSpotLights:v.spot.length,numSpotLightMaps:v.spotLightMap.length,numRectAreaLights:v.rectArea.length,numHemiLights:v.hemi.length,numDirLightShadows:v.directionalShadowMap.length,numPointLightShadows:v.pointShadowMap.length,numSpotLightShadows:v.spotShadowMap.length,numSpotLightShadowsWithMaps:v.numSpotLightShadowsWithMaps,numLightProbes:v.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:M.dithering,shadowMapEnabled:r.shadowMap.enabled&&R.length>0,shadowMapType:r.shadowMap.type,toneMapping:ct,decodeVideoTexture:lt&&M.map.isVideoTexture===!0&&ke.getTransfer(M.map.colorSpace)===Je,decodeVideoTextureEmissive:it&&M.emissiveMap.isVideoTexture===!0&&ke.getTransfer(M.emissiveMap.colorSpace)===Je,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===zt,flipSided:M.side===Nt,useDepthPacking:M.depthPacking>=0,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionClipCullDistance:Ie&&M.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Ie&&M.extensions.multiDraw===!0||Fe)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:M.customProgramCacheKey()};return Mt.vertexUv1s=c.has(1),Mt.vertexUv2s=c.has(2),Mt.vertexUv3s=c.has(3),c.clear(),Mt}function p(M){const v=[];if(M.shaderID?v.push(M.shaderID):(v.push(M.customVertexShaderID),v.push(M.customFragmentShaderID)),M.defines!==void 0)for(const R in M.defines)v.push(R),v.push(M.defines[R]);return M.isRawShaderMaterial===!1&&(S(v,M),E(v,M),v.push(r.outputColorSpace)),v.push(M.customProgramCacheKey),v.join()}function S(M,v){M.push(v.precision),M.push(v.outputColorSpace),M.push(v.envMapMode),M.push(v.envMapCubeUVHeight),M.push(v.mapUv),M.push(v.alphaMapUv),M.push(v.lightMapUv),M.push(v.aoMapUv),M.push(v.bumpMapUv),M.push(v.normalMapUv),M.push(v.displacementMapUv),M.push(v.emissiveMapUv),M.push(v.metalnessMapUv),M.push(v.roughnessMapUv),M.push(v.anisotropyMapUv),M.push(v.clearcoatMapUv),M.push(v.clearcoatNormalMapUv),M.push(v.clearcoatRoughnessMapUv),M.push(v.iridescenceMapUv),M.push(v.iridescenceThicknessMapUv),M.push(v.sheenColorMapUv),M.push(v.sheenRoughnessMapUv),M.push(v.specularMapUv),M.push(v.specularColorMapUv),M.push(v.specularIntensityMapUv),M.push(v.transmissionMapUv),M.push(v.thicknessMapUv),M.push(v.combine),M.push(v.fogExp2),M.push(v.sizeAttenuation),M.push(v.morphTargetsCount),M.push(v.morphAttributeCount),M.push(v.numDirLights),M.push(v.numPointLights),M.push(v.numSpotLights),M.push(v.numSpotLightMaps),M.push(v.numHemiLights),M.push(v.numRectAreaLights),M.push(v.numDirLightShadows),M.push(v.numPointLightShadows),M.push(v.numSpotLightShadows),M.push(v.numSpotLightShadowsWithMaps),M.push(v.numLightProbes),M.push(v.shadowMapType),M.push(v.toneMapping),M.push(v.numClippingPlanes),M.push(v.numClipIntersection),M.push(v.depthPacking)}function E(M,v){o.disableAll(),v.supportsVertexTextures&&o.enable(0),v.instancing&&o.enable(1),v.instancingColor&&o.enable(2),v.instancingMorph&&o.enable(3),v.matcap&&o.enable(4),v.envMap&&o.enable(5),v.normalMapObjectSpace&&o.enable(6),v.normalMapTangentSpace&&o.enable(7),v.clearcoat&&o.enable(8),v.iridescence&&o.enable(9),v.alphaTest&&o.enable(10),v.vertexColors&&o.enable(11),v.vertexAlphas&&o.enable(12),v.vertexUv1s&&o.enable(13),v.vertexUv2s&&o.enable(14),v.vertexUv3s&&o.enable(15),v.vertexTangents&&o.enable(16),v.anisotropy&&o.enable(17),v.alphaHash&&o.enable(18),v.batching&&o.enable(19),v.dispersion&&o.enable(20),v.batchingColor&&o.enable(21),M.push(o.mask),o.disableAll(),v.fog&&o.enable(0),v.useFog&&o.enable(1),v.flatShading&&o.enable(2),v.logarithmicDepthBuffer&&o.enable(3),v.reverseDepthBuffer&&o.enable(4),v.skinning&&o.enable(5),v.morphTargets&&o.enable(6),v.morphNormals&&o.enable(7),v.morphColors&&o.enable(8),v.premultipliedAlpha&&o.enable(9),v.shadowMapEnabled&&o.enable(10),v.doubleSided&&o.enable(11),v.flipSided&&o.enable(12),v.useDepthPacking&&o.enable(13),v.dithering&&o.enable(14),v.transmission&&o.enable(15),v.sheen&&o.enable(16),v.opaque&&o.enable(17),v.pointsUvs&&o.enable(18),v.decodeVideoTexture&&o.enable(19),v.decodeVideoTextureEmissive&&o.enable(20),v.alphaToCoverage&&o.enable(21),M.push(o.mask)}function x(M){const v=g[M.type];let R;if(v){const z=on[v];R=Pu.clone(z.uniforms)}else R=M.uniforms;return R}function L(M,v){let R;for(let z=0,O=h.length;z<O;z++){const X=h[z];if(X.cacheKey===v){R=X,++R.usedTimes;break}}return R===void 0&&(R=new qm(r,v,M,s),h.push(R)),R}function w(M){if(--M.usedTimes===0){const v=h.indexOf(M);h[v]=h[h.length-1],h.pop(),M.destroy()}}function A(M){l.remove(M)}function I(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:x,acquireProgram:L,releaseProgram:w,releaseShaderCache:A,programs:h,dispose:I}}function Zm(){let r=new WeakMap;function e(a){return r.has(a)}function t(a){let o=r.get(a);return o===void 0&&(o={},r.set(a,o)),o}function n(a){r.delete(a)}function i(a,o,l){r.get(a)[o]=l}function s(){r=new WeakMap}return{has:e,get:t,remove:n,update:i,dispose:s}}function Jm(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.material.id!==e.material.id?r.material.id-e.material.id:r.z!==e.z?r.z-e.z:r.id-e.id}function Il(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.z!==e.z?e.z-r.z:r.id-e.id}function Pl(){const r=[];let e=0;const t=[],n=[],i=[];function s(){e=0,t.length=0,n.length=0,i.length=0}function a(u,d,f,g,_,m){let p=r[e];return p===void 0?(p={id:u.id,object:u,geometry:d,material:f,groupOrder:g,renderOrder:u.renderOrder,z:_,group:m},r[e]=p):(p.id=u.id,p.object=u,p.geometry=d,p.material=f,p.groupOrder=g,p.renderOrder=u.renderOrder,p.z=_,p.group=m),e++,p}function o(u,d,f,g,_,m){const p=a(u,d,f,g,_,m);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):t.push(p)}function l(u,d,f,g,_,m){const p=a(u,d,f,g,_,m);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):t.unshift(p)}function c(u,d){t.length>1&&t.sort(u||Jm),n.length>1&&n.sort(d||Il),i.length>1&&i.sort(d||Il)}function h(){for(let u=e,d=r.length;u<d;u++){const f=r[u];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:i,init:s,push:o,unshift:l,finish:h,sort:c}}function Qm(){let r=new WeakMap;function e(n,i){const s=r.get(n);let a;return s===void 0?(a=new Pl,r.set(n,[a])):i>=s.length?(a=new Pl,s.push(a)):a=s[i],a}function t(){r=new WeakMap}return{get:e,dispose:t}}function eg(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new C,color:new ye};break;case"SpotLight":t={position:new C,direction:new C,color:new ye,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new C,color:new ye,distance:0,decay:0};break;case"HemisphereLight":t={direction:new C,skyColor:new ye,groundColor:new ye};break;case"RectAreaLight":t={color:new ye,position:new C,halfWidth:new C,halfHeight:new C};break}return r[e.id]=t,t}}}function tg(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Me};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Me};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Me,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[e.id]=t,t}}}let ng=0;function ig(r,e){return(e.castShadow?2:0)-(r.castShadow?2:0)+(e.map?1:0)-(r.map?1:0)}function sg(r){const e=new eg,t=tg(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new C);const i=new C,s=new Re,a=new Re;function o(c){let h=0,u=0,d=0;for(let M=0;M<9;M++)n.probe[M].set(0,0,0);let f=0,g=0,_=0,m=0,p=0,S=0,E=0,x=0,L=0,w=0,A=0;c.sort(ig);for(let M=0,v=c.length;M<v;M++){const R=c[M],z=R.color,O=R.intensity,X=R.distance,V=R.shadow&&R.shadow.map?R.shadow.map.texture:null;if(R.isAmbientLight)h+=z.r*O,u+=z.g*O,d+=z.b*O;else if(R.isLightProbe){for(let W=0;W<9;W++)n.probe[W].addScaledVector(R.sh.coefficients[W],O);A++}else if(R.isDirectionalLight){const W=e.get(R);if(W.color.copy(R.color).multiplyScalar(R.intensity),R.castShadow){const Y=R.shadow,H=t.get(R);H.shadowIntensity=Y.intensity,H.shadowBias=Y.bias,H.shadowNormalBias=Y.normalBias,H.shadowRadius=Y.radius,H.shadowMapSize=Y.mapSize,n.directionalShadow[f]=H,n.directionalShadowMap[f]=V,n.directionalShadowMatrix[f]=R.shadow.matrix,S++}n.directional[f]=W,f++}else if(R.isSpotLight){const W=e.get(R);W.position.setFromMatrixPosition(R.matrixWorld),W.color.copy(z).multiplyScalar(O),W.distance=X,W.coneCos=Math.cos(R.angle),W.penumbraCos=Math.cos(R.angle*(1-R.penumbra)),W.decay=R.decay,n.spot[_]=W;const Y=R.shadow;if(R.map&&(n.spotLightMap[L]=R.map,L++,Y.updateMatrices(R),R.castShadow&&w++),n.spotLightMatrix[_]=Y.matrix,R.castShadow){const H=t.get(R);H.shadowIntensity=Y.intensity,H.shadowBias=Y.bias,H.shadowNormalBias=Y.normalBias,H.shadowRadius=Y.radius,H.shadowMapSize=Y.mapSize,n.spotShadow[_]=H,n.spotShadowMap[_]=V,x++}_++}else if(R.isRectAreaLight){const W=e.get(R);W.color.copy(z).multiplyScalar(O),W.halfWidth.set(R.width*.5,0,0),W.halfHeight.set(0,R.height*.5,0),n.rectArea[m]=W,m++}else if(R.isPointLight){const W=e.get(R);if(W.color.copy(R.color).multiplyScalar(R.intensity),W.distance=R.distance,W.decay=R.decay,R.castShadow){const Y=R.shadow,H=t.get(R);H.shadowIntensity=Y.intensity,H.shadowBias=Y.bias,H.shadowNormalBias=Y.normalBias,H.shadowRadius=Y.radius,H.shadowMapSize=Y.mapSize,H.shadowCameraNear=Y.camera.near,H.shadowCameraFar=Y.camera.far,n.pointShadow[g]=H,n.pointShadowMap[g]=V,n.pointShadowMatrix[g]=R.shadow.matrix,E++}n.point[g]=W,g++}else if(R.isHemisphereLight){const W=e.get(R);W.skyColor.copy(R.color).multiplyScalar(O),W.groundColor.copy(R.groundColor).multiplyScalar(O),n.hemi[p]=W,p++}}m>0&&(r.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ne.LTC_FLOAT_1,n.rectAreaLTC2=ne.LTC_FLOAT_2):(n.rectAreaLTC1=ne.LTC_HALF_1,n.rectAreaLTC2=ne.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=u,n.ambient[2]=d;const I=n.hash;(I.directionalLength!==f||I.pointLength!==g||I.spotLength!==_||I.rectAreaLength!==m||I.hemiLength!==p||I.numDirectionalShadows!==S||I.numPointShadows!==E||I.numSpotShadows!==x||I.numSpotMaps!==L||I.numLightProbes!==A)&&(n.directional.length=f,n.spot.length=_,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=S,n.directionalShadowMap.length=S,n.pointShadow.length=E,n.pointShadowMap.length=E,n.spotShadow.length=x,n.spotShadowMap.length=x,n.directionalShadowMatrix.length=S,n.pointShadowMatrix.length=E,n.spotLightMatrix.length=x+L-w,n.spotLightMap.length=L,n.numSpotLightShadowsWithMaps=w,n.numLightProbes=A,I.directionalLength=f,I.pointLength=g,I.spotLength=_,I.rectAreaLength=m,I.hemiLength=p,I.numDirectionalShadows=S,I.numPointShadows=E,I.numSpotShadows=x,I.numSpotMaps=L,I.numLightProbes=A,n.version=ng++)}function l(c,h){let u=0,d=0,f=0,g=0,_=0;const m=h.matrixWorldInverse;for(let p=0,S=c.length;p<S;p++){const E=c[p];if(E.isDirectionalLight){const x=n.directional[u];x.direction.setFromMatrixPosition(E.matrixWorld),i.setFromMatrixPosition(E.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(m),u++}else if(E.isSpotLight){const x=n.spot[f];x.position.setFromMatrixPosition(E.matrixWorld),x.position.applyMatrix4(m),x.direction.setFromMatrixPosition(E.matrixWorld),i.setFromMatrixPosition(E.target.matrixWorld),x.direction.sub(i),x.direction.transformDirection(m),f++}else if(E.isRectAreaLight){const x=n.rectArea[g];x.position.setFromMatrixPosition(E.matrixWorld),x.position.applyMatrix4(m),a.identity(),s.copy(E.matrixWorld),s.premultiply(m),a.extractRotation(s),x.halfWidth.set(E.width*.5,0,0),x.halfHeight.set(0,E.height*.5,0),x.halfWidth.applyMatrix4(a),x.halfHeight.applyMatrix4(a),g++}else if(E.isPointLight){const x=n.point[d];x.position.setFromMatrixPosition(E.matrixWorld),x.position.applyMatrix4(m),d++}else if(E.isHemisphereLight){const x=n.hemi[_];x.direction.setFromMatrixPosition(E.matrixWorld),x.direction.transformDirection(m),_++}}}return{setup:o,setupView:l,state:n}}function Dl(r){const e=new sg(r),t=[],n=[];function i(h){c.camera=h,t.length=0,n.length=0}function s(h){t.push(h)}function a(h){n.push(h)}function o(){e.setup(t)}function l(h){e.setupView(t,h)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:c,setupLights:o,setupLightsView:l,pushLight:s,pushShadow:a}}function rg(r){let e=new WeakMap;function t(i,s=0){const a=e.get(i);let o;return a===void 0?(o=new Dl(r),e.set(i,[o])):s>=a.length?(o=new Dl(r),a.push(o)):o=a[s],o}function n(){e=new WeakMap}return{get:t,dispose:n}}class ag extends Ct{static get type(){return"MeshDepthMaterial"}constructor(e){super(),this.isMeshDepthMaterial=!0,this.depthPacking=zh,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class og extends Ct{static get type(){return"MeshDistanceMaterial"}constructor(e){super(),this.isMeshDistanceMaterial=!0,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const lg=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function hg(r,e,t){let n=new uo;const i=new Me,s=new Me,a=new je,o=new ag({depthPacking:Hh}),l=new og,c={},h=t.maxTextureSize,u={[hn]:Nt,[Nt]:hn,[zt]:zt},d=new Wn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Me},radius:{value:4}},vertexShader:lg,fragmentShader:cg}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new It;g.setAttribute("position",new at(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new pt(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=bc;let p=this.type;this.render=function(w,A,I){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;const M=r.getRenderTarget(),v=r.getActiveCubeFace(),R=r.getActiveMipmapLevel(),z=r.state;z.setBlending(Hn),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const O=p!==bn&&this.type===bn,X=p===bn&&this.type!==bn;for(let V=0,W=w.length;V<W;V++){const Y=w[V],H=Y.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;i.copy(H.mapSize);const te=H.getFrameExtents();if(i.multiply(te),s.copy(H.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/te.x),i.x=s.x*te.x,H.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/te.y),i.y=s.y*te.y,H.mapSize.y=s.y)),H.map===null||O===!0||X===!0){const _e=this.type!==bn?{minFilter:Et,magFilter:Et}:{};H.map!==null&&H.map.dispose(),H.map=new ii(i.x,i.y,_e),H.map.texture.name=Y.name+".shadowMap",H.camera.updateProjectionMatrix()}r.setRenderTarget(H.map),r.clear();const ce=H.getViewportCount();for(let _e=0;_e<ce;_e++){const Ne=H.getViewport(_e);a.set(s.x*Ne.x,s.y*Ne.y,s.x*Ne.z,s.y*Ne.w),z.viewport(a),H.updateMatrices(Y,_e),n=H.getFrustum(),x(A,I,H.camera,Y,this.type)}H.isPointLightShadow!==!0&&this.type===bn&&S(H,I),H.needsUpdate=!1}p=this.type,m.needsUpdate=!1,r.setRenderTarget(M,v,R)};function S(w,A){const I=e.update(_);d.defines.VSM_SAMPLES!==w.blurSamples&&(d.defines.VSM_SAMPLES=w.blurSamples,f.defines.VSM_SAMPLES=w.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new ii(i.x,i.y)),d.uniforms.shadow_pass.value=w.map.texture,d.uniforms.resolution.value=w.mapSize,d.uniforms.radius.value=w.radius,r.setRenderTarget(w.mapPass),r.clear(),r.renderBufferDirect(A,null,I,d,_,null),f.uniforms.shadow_pass.value=w.mapPass.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,r.setRenderTarget(w.map),r.clear(),r.renderBufferDirect(A,null,I,f,_,null)}function E(w,A,I,M){let v=null;const R=I.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(R!==void 0)v=R;else if(v=I.isPointLight===!0?l:o,r.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const z=v.uuid,O=A.uuid;let X=c[z];X===void 0&&(X={},c[z]=X);let V=X[O];V===void 0&&(V=v.clone(),X[O]=V,A.addEventListener("dispose",L)),v=V}if(v.visible=A.visible,v.wireframe=A.wireframe,M===bn?v.side=A.shadowSide!==null?A.shadowSide:A.side:v.side=A.shadowSide!==null?A.shadowSide:u[A.side],v.alphaMap=A.alphaMap,v.alphaTest=A.alphaTest,v.map=A.map,v.clipShadows=A.clipShadows,v.clippingPlanes=A.clippingPlanes,v.clipIntersection=A.clipIntersection,v.displacementMap=A.displacementMap,v.displacementScale=A.displacementScale,v.displacementBias=A.displacementBias,v.wireframeLinewidth=A.wireframeLinewidth,v.linewidth=A.linewidth,I.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const z=r.properties.get(v);z.light=I}return v}function x(w,A,I,M,v){if(w.visible===!1)return;if(w.layers.test(A.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&v===bn)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,w.matrixWorld);const O=e.update(w),X=w.material;if(Array.isArray(X)){const V=O.groups;for(let W=0,Y=V.length;W<Y;W++){const H=V[W],te=X[H.materialIndex];if(te&&te.visible){const ce=E(w,te,M,v);w.onBeforeShadow(r,w,A,I,O,ce,H),r.renderBufferDirect(I,null,O,ce,w,H),w.onAfterShadow(r,w,A,I,O,ce,H)}}}else if(X.visible){const V=E(w,X,M,v);w.onBeforeShadow(r,w,A,I,O,V,null),r.renderBufferDirect(I,null,O,V,w,null),w.onAfterShadow(r,w,A,I,O,V,null)}}const z=w.children;for(let O=0,X=z.length;O<X;O++)x(z[O],A,I,M,v)}function L(w){w.target.removeEventListener("dispose",L);for(const I in c){const M=c[I],v=w.target.uuid;v in M&&(M[v].dispose(),delete M[v])}}}const ug={[oa]:la,[ca]:da,[ha]:fa,[Di]:ua,[la]:oa,[da]:ca,[fa]:ha,[ua]:Di};function dg(r,e){function t(){let P=!1;const ie=new je;let G=null;const $=new je(0,0,0,0);return{setMask:function(le){G!==le&&!P&&(r.colorMask(le,le,le,le),G=le)},setLocked:function(le){P=le},setClear:function(le,ae,Ie,ct,Mt){Mt===!0&&(le*=ct,ae*=ct,Ie*=ct),ie.set(le,ae,Ie,ct),$.equals(ie)===!1&&(r.clearColor(le,ae,Ie,ct),$.copy(ie))},reset:function(){P=!1,G=null,$.set(-1,0,0,0)}}}function n(){let P=!1,ie=!1,G=null,$=null,le=null;return{setReversed:function(ae){if(ie!==ae){const Ie=e.get("EXT_clip_control");ie?Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.ZERO_TO_ONE_EXT):Ie.clipControlEXT(Ie.LOWER_LEFT_EXT,Ie.NEGATIVE_ONE_TO_ONE_EXT);const ct=le;le=null,this.setClear(ct)}ie=ae},getReversed:function(){return ie},setTest:function(ae){ae?se(r.DEPTH_TEST):Te(r.DEPTH_TEST)},setMask:function(ae){G!==ae&&!P&&(r.depthMask(ae),G=ae)},setFunc:function(ae){if(ie&&(ae=ug[ae]),$!==ae){switch(ae){case oa:r.depthFunc(r.NEVER);break;case la:r.depthFunc(r.ALWAYS);break;case ca:r.depthFunc(r.LESS);break;case Di:r.depthFunc(r.LEQUAL);break;case ha:r.depthFunc(r.EQUAL);break;case ua:r.depthFunc(r.GEQUAL);break;case da:r.depthFunc(r.GREATER);break;case fa:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}$=ae}},setLocked:function(ae){P=ae},setClear:function(ae){le!==ae&&(ie&&(ae=1-ae),r.clearDepth(ae),le=ae)},reset:function(){P=!1,G=null,$=null,le=null,ie=!1}}}function i(){let P=!1,ie=null,G=null,$=null,le=null,ae=null,Ie=null,ct=null,Mt=null;return{setTest:function($e){P||($e?se(r.STENCIL_TEST):Te(r.STENCIL_TEST))},setMask:function($e){ie!==$e&&!P&&(r.stencilMask($e),ie=$e)},setFunc:function($e,Kt,pn){(G!==$e||$!==Kt||le!==pn)&&(r.stencilFunc($e,Kt,pn),G=$e,$=Kt,le=pn)},setOp:function($e,Kt,pn){(ae!==$e||Ie!==Kt||ct!==pn)&&(r.stencilOp($e,Kt,pn),ae=$e,Ie=Kt,ct=pn)},setLocked:function($e){P=$e},setClear:function($e){Mt!==$e&&(r.clearStencil($e),Mt=$e)},reset:function(){P=!1,ie=null,G=null,$=null,le=null,ae=null,Ie=null,ct=null,Mt=null}}}const s=new t,a=new n,o=new i,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],g=null,_=!1,m=null,p=null,S=null,E=null,x=null,L=null,w=null,A=new ye(0,0,0),I=0,M=!1,v=null,R=null,z=null,O=null,X=null;const V=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,Y=0;const H=r.getParameter(r.VERSION);H.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(H)[1]),W=Y>=1):H.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),W=Y>=2);let te=null,ce={};const _e=r.getParameter(r.SCISSOR_BOX),Ne=r.getParameter(r.VIEWPORT),et=new je().fromArray(_e),j=new je().fromArray(Ne);function ee(P,ie,G,$){const le=new Uint8Array(4),ae=r.createTexture();r.bindTexture(P,ae),r.texParameteri(P,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(P,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Ie=0;Ie<G;Ie++)P===r.TEXTURE_3D||P===r.TEXTURE_2D_ARRAY?r.texImage3D(ie,0,r.RGBA,1,1,$,0,r.RGBA,r.UNSIGNED_BYTE,le):r.texImage2D(ie+Ie,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,le);return ae}const ge={};ge[r.TEXTURE_2D]=ee(r.TEXTURE_2D,r.TEXTURE_2D,1),ge[r.TEXTURE_CUBE_MAP]=ee(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),ge[r.TEXTURE_2D_ARRAY]=ee(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),ge[r.TEXTURE_3D]=ee(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),se(r.DEPTH_TEST),a.setFunc(Di),ze(!1),He(Do),se(r.CULL_FACE),N(Hn);function se(P){h[P]!==!0&&(r.enable(P),h[P]=!0)}function Te(P){h[P]!==!1&&(r.disable(P),h[P]=!1)}function Ce(P,ie){return u[P]!==ie?(r.bindFramebuffer(P,ie),u[P]=ie,P===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=ie),P===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=ie),!0):!1}function Fe(P,ie){let G=f,$=!1;if(P){G=d.get(ie),G===void 0&&(G=[],d.set(ie,G));const le=P.textures;if(G.length!==le.length||G[0]!==r.COLOR_ATTACHMENT0){for(let ae=0,Ie=le.length;ae<Ie;ae++)G[ae]=r.COLOR_ATTACHMENT0+ae;G.length=le.length,$=!0}}else G[0]!==r.BACK&&(G[0]=r.BACK,$=!0);$&&r.drawBuffers(G)}function lt(P){return g!==P?(r.useProgram(P),g=P,!0):!1}const Ve={[ei]:r.FUNC_ADD,[dh]:r.FUNC_SUBTRACT,[fh]:r.FUNC_REVERSE_SUBTRACT};Ve[ph]=r.MIN,Ve[mh]=r.MAX;const ht={[gh]:r.ZERO,[_h]:r.ONE,[xh]:r.SRC_COLOR,[ra]:r.SRC_ALPHA,[Eh]:r.SRC_ALPHA_SATURATE,[bh]:r.DST_COLOR,[yh]:r.DST_ALPHA,[vh]:r.ONE_MINUS_SRC_COLOR,[aa]:r.ONE_MINUS_SRC_ALPHA,[Sh]:r.ONE_MINUS_DST_COLOR,[Mh]:r.ONE_MINUS_DST_ALPHA,[Th]:r.CONSTANT_COLOR,[wh]:r.ONE_MINUS_CONSTANT_COLOR,[Ah]:r.CONSTANT_ALPHA,[Rh]:r.ONE_MINUS_CONSTANT_ALPHA};function N(P,ie,G,$,le,ae,Ie,ct,Mt,$e){if(P===Hn){_===!0&&(Te(r.BLEND),_=!1);return}if(_===!1&&(se(r.BLEND),_=!0),P!==uh){if(P!==m||$e!==M){if((p!==ei||x!==ei)&&(r.blendEquation(r.FUNC_ADD),p=ei,x=ei),$e)switch(P){case Ri:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Uo:r.blendFunc(r.ONE,r.ONE);break;case No:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Fo:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}else switch(P){case Ri:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Uo:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case No:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Fo:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",P);break}S=null,E=null,L=null,w=null,A.set(0,0,0),I=0,m=P,M=$e}return}le=le||ie,ae=ae||G,Ie=Ie||$,(ie!==p||le!==x)&&(r.blendEquationSeparate(Ve[ie],Ve[le]),p=ie,x=le),(G!==S||$!==E||ae!==L||Ie!==w)&&(r.blendFuncSeparate(ht[G],ht[$],ht[ae],ht[Ie]),S=G,E=$,L=ae,w=Ie),(ct.equals(A)===!1||Mt!==I)&&(r.blendColor(ct.r,ct.g,ct.b,Mt),A.copy(ct),I=Mt),m=P,M=!1}function Vt(P,ie){P.side===zt?Te(r.CULL_FACE):se(r.CULL_FACE);let G=P.side===Nt;ie&&(G=!G),ze(G),P.blending===Ri&&P.transparent===!1?N(Hn):N(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),s.setMask(P.colorWrite);const $=P.stencilWrite;o.setTest($),$&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),it(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?se(r.SAMPLE_ALPHA_TO_COVERAGE):Te(r.SAMPLE_ALPHA_TO_COVERAGE)}function ze(P){v!==P&&(P?r.frontFace(r.CW):r.frontFace(r.CCW),v=P)}function He(P){P!==ch?(se(r.CULL_FACE),P!==R&&(P===Do?r.cullFace(r.BACK):P===hh?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Te(r.CULL_FACE),R=P}function Se(P){P!==z&&(W&&r.lineWidth(P),z=P)}function it(P,ie,G){P?(se(r.POLYGON_OFFSET_FILL),(O!==ie||X!==G)&&(r.polygonOffset(ie,G),O=ie,X=G)):Te(r.POLYGON_OFFSET_FILL)}function be(P){P?se(r.SCISSOR_TEST):Te(r.SCISSOR_TEST)}function T(P){P===void 0&&(P=r.TEXTURE0+V-1),te!==P&&(r.activeTexture(P),te=P)}function y(P,ie,G){G===void 0&&(te===null?G=r.TEXTURE0+V-1:G=te);let $=ce[G];$===void 0&&($={type:void 0,texture:void 0},ce[G]=$),($.type!==P||$.texture!==ie)&&(te!==G&&(r.activeTexture(G),te=G),r.bindTexture(P,ie||ge[P]),$.type=P,$.texture=ie)}function F(){const P=ce[te];P!==void 0&&P.type!==void 0&&(r.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function K(){try{r.compressedTexImage2D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Z(){try{r.compressedTexImage3D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function q(){try{r.texSubImage2D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function xe(){try{r.texSubImage3D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function re(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function he(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function We(){try{r.texStorage2D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function J(){try{r.texStorage3D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function ue(){try{r.texImage2D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function Ee(){try{r.texImage3D.apply(r,arguments)}catch(P){console.error("THREE.WebGLState:",P)}}function we(P){et.equals(P)===!1&&(r.scissor(P.x,P.y,P.z,P.w),et.copy(P))}function de(P){j.equals(P)===!1&&(r.viewport(P.x,P.y,P.z,P.w),j.copy(P))}function Ge(P,ie){let G=c.get(ie);G===void 0&&(G=new WeakMap,c.set(ie,G));let $=G.get(P);$===void 0&&($=r.getUniformBlockIndex(ie,P.name),G.set(P,$))}function De(P,ie){const $=c.get(ie).get(P);l.get(ie)!==$&&(r.uniformBlockBinding(ie,$,P.__bindingPointIndex),l.set(ie,$))}function tt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),a.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),h={},te=null,ce={},u={},d=new WeakMap,f=[],g=null,_=!1,m=null,p=null,S=null,E=null,x=null,L=null,w=null,A=new ye(0,0,0),I=0,M=!1,v=null,R=null,z=null,O=null,X=null,et.set(0,0,r.canvas.width,r.canvas.height),j.set(0,0,r.canvas.width,r.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:se,disable:Te,bindFramebuffer:Ce,drawBuffers:Fe,useProgram:lt,setBlending:N,setMaterial:Vt,setFlipSided:ze,setCullFace:He,setLineWidth:Se,setPolygonOffset:it,setScissorTest:be,activeTexture:T,bindTexture:y,unbindTexture:F,compressedTexImage2D:K,compressedTexImage3D:Z,texImage2D:ue,texImage3D:Ee,updateUBOMapping:Ge,uniformBlockBinding:De,texStorage2D:We,texStorage3D:J,texSubImage2D:q,texSubImage3D:xe,compressedTexSubImage2D:re,compressedTexSubImage3D:he,scissor:we,viewport:de,reset:tt}}function Ul(r,e,t,n){const i=fg(n);switch(t){case Cc:return r*e;case Ic:return r*e;case Pc:return r*e*2;case so:return r*e/i.components*i.byteLength;case ro:return r*e/i.components*i.byteLength;case Dc:return r*e*2/i.components*i.byteLength;case ao:return r*e*2/i.components*i.byteLength;case Lc:return r*e*3/i.components*i.byteLength;case Ht:return r*e*4/i.components*i.byteLength;case oo:return r*e*4/i.components*i.byteLength;case Js:case Qs:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case er:case tr:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case _a:case va:return Math.max(r,16)*Math.max(e,8)/4;case ga:case xa:return Math.max(r,8)*Math.max(e,8)/2;case ya:case Ma:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case ba:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Sa:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Ea:return Math.floor((r+4)/5)*Math.floor((e+3)/4)*16;case Ta:return Math.floor((r+4)/5)*Math.floor((e+4)/5)*16;case wa:return Math.floor((r+5)/6)*Math.floor((e+4)/5)*16;case Aa:return Math.floor((r+5)/6)*Math.floor((e+5)/6)*16;case Ra:return Math.floor((r+7)/8)*Math.floor((e+4)/5)*16;case Ca:return Math.floor((r+7)/8)*Math.floor((e+5)/6)*16;case La:return Math.floor((r+7)/8)*Math.floor((e+7)/8)*16;case Ia:return Math.floor((r+9)/10)*Math.floor((e+4)/5)*16;case Pa:return Math.floor((r+9)/10)*Math.floor((e+5)/6)*16;case Da:return Math.floor((r+9)/10)*Math.floor((e+7)/8)*16;case Ua:return Math.floor((r+9)/10)*Math.floor((e+9)/10)*16;case Na:return Math.floor((r+11)/12)*Math.floor((e+9)/10)*16;case Fa:return Math.floor((r+11)/12)*Math.floor((e+11)/12)*16;case nr:case Oa:case Ba:return Math.ceil(r/4)*Math.ceil(e/4)*16;case Uc:case ka:return Math.ceil(r/4)*Math.ceil(e/4)*8;case za:case Ha:return Math.ceil(r/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function fg(r){switch(r){case Cn:case wc:return{byteLength:1,components:1};case ms:case Ac:case _s:return{byteLength:2,components:1};case no:case io:return{byteLength:2,components:4};case ni:case to:case nn:return{byteLength:4,components:1};case Rc:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${r}.`)}function pg(r,e,t,n,i,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Me,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(T,y){return f?new OffscreenCanvas(T,y):gs("canvas")}function _(T,y,F){let K=1;const Z=be(T);if((Z.width>F||Z.height>F)&&(K=F/Math.max(Z.width,Z.height)),K<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const q=Math.floor(K*Z.width),xe=Math.floor(K*Z.height);u===void 0&&(u=g(q,xe));const re=y?g(q,xe):u;return re.width=q,re.height=xe,re.getContext("2d").drawImage(T,0,0,q,xe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+q+"x"+xe+")."),re}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),T;return T}function m(T){return T.generateMipmaps}function p(T){r.generateMipmap(T)}function S(T){return T.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?r.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function E(T,y,F,K,Z=!1){if(T!==null){if(r[T]!==void 0)return r[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let q=y;if(y===r.RED&&(F===r.FLOAT&&(q=r.R32F),F===r.HALF_FLOAT&&(q=r.R16F),F===r.UNSIGNED_BYTE&&(q=r.R8)),y===r.RED_INTEGER&&(F===r.UNSIGNED_BYTE&&(q=r.R8UI),F===r.UNSIGNED_SHORT&&(q=r.R16UI),F===r.UNSIGNED_INT&&(q=r.R32UI),F===r.BYTE&&(q=r.R8I),F===r.SHORT&&(q=r.R16I),F===r.INT&&(q=r.R32I)),y===r.RG&&(F===r.FLOAT&&(q=r.RG32F),F===r.HALF_FLOAT&&(q=r.RG16F),F===r.UNSIGNED_BYTE&&(q=r.RG8)),y===r.RG_INTEGER&&(F===r.UNSIGNED_BYTE&&(q=r.RG8UI),F===r.UNSIGNED_SHORT&&(q=r.RG16UI),F===r.UNSIGNED_INT&&(q=r.RG32UI),F===r.BYTE&&(q=r.RG8I),F===r.SHORT&&(q=r.RG16I),F===r.INT&&(q=r.RG32I)),y===r.RGB_INTEGER&&(F===r.UNSIGNED_BYTE&&(q=r.RGB8UI),F===r.UNSIGNED_SHORT&&(q=r.RGB16UI),F===r.UNSIGNED_INT&&(q=r.RGB32UI),F===r.BYTE&&(q=r.RGB8I),F===r.SHORT&&(q=r.RGB16I),F===r.INT&&(q=r.RGB32I)),y===r.RGBA_INTEGER&&(F===r.UNSIGNED_BYTE&&(q=r.RGBA8UI),F===r.UNSIGNED_SHORT&&(q=r.RGBA16UI),F===r.UNSIGNED_INT&&(q=r.RGBA32UI),F===r.BYTE&&(q=r.RGBA8I),F===r.SHORT&&(q=r.RGBA16I),F===r.INT&&(q=r.RGBA32I)),y===r.RGB&&F===r.UNSIGNED_INT_5_9_9_9_REV&&(q=r.RGB9_E5),y===r.RGBA){const xe=Z?fr:ke.getTransfer(K);F===r.FLOAT&&(q=r.RGBA32F),F===r.HALF_FLOAT&&(q=r.RGBA16F),F===r.UNSIGNED_BYTE&&(q=xe===Je?r.SRGB8_ALPHA8:r.RGBA8),F===r.UNSIGNED_SHORT_4_4_4_4&&(q=r.RGBA4),F===r.UNSIGNED_SHORT_5_5_5_1&&(q=r.RGB5_A1)}return(q===r.R16F||q===r.R32F||q===r.RG16F||q===r.RG32F||q===r.RGBA16F||q===r.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function x(T,y){let F;return T?y===null||y===ni||y===Fi?F=r.DEPTH24_STENCIL8:y===nn?F=r.DEPTH32F_STENCIL8:y===ms&&(F=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===ni||y===Fi?F=r.DEPTH_COMPONENT24:y===nn?F=r.DEPTH_COMPONENT32F:y===ms&&(F=r.DEPTH_COMPONENT16),F}function L(T,y){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==Et&&T.minFilter!==Ut?Math.log2(Math.max(y.width,y.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?y.mipmaps.length:1}function w(T){const y=T.target;y.removeEventListener("dispose",w),I(y),y.isVideoTexture&&h.delete(y)}function A(T){const y=T.target;y.removeEventListener("dispose",A),v(y)}function I(T){const y=n.get(T);if(y.__webglInit===void 0)return;const F=T.source,K=d.get(F);if(K){const Z=K[y.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&M(T),Object.keys(K).length===0&&d.delete(F)}n.remove(T)}function M(T){const y=n.get(T);r.deleteTexture(y.__webglTexture);const F=T.source,K=d.get(F);delete K[y.__cacheKey],a.memory.textures--}function v(T){const y=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(y.__webglFramebuffer[K]))for(let Z=0;Z<y.__webglFramebuffer[K].length;Z++)r.deleteFramebuffer(y.__webglFramebuffer[K][Z]);else r.deleteFramebuffer(y.__webglFramebuffer[K]);y.__webglDepthbuffer&&r.deleteRenderbuffer(y.__webglDepthbuffer[K])}else{if(Array.isArray(y.__webglFramebuffer))for(let K=0;K<y.__webglFramebuffer.length;K++)r.deleteFramebuffer(y.__webglFramebuffer[K]);else r.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&r.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&r.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let K=0;K<y.__webglColorRenderbuffer.length;K++)y.__webglColorRenderbuffer[K]&&r.deleteRenderbuffer(y.__webglColorRenderbuffer[K]);y.__webglDepthRenderbuffer&&r.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const F=T.textures;for(let K=0,Z=F.length;K<Z;K++){const q=n.get(F[K]);q.__webglTexture&&(r.deleteTexture(q.__webglTexture),a.memory.textures--),n.remove(F[K])}n.remove(T)}let R=0;function z(){R=0}function O(){const T=R;return T>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+i.maxTextures),R+=1,T}function X(T){const y=[];return y.push(T.wrapS),y.push(T.wrapT),y.push(T.wrapR||0),y.push(T.magFilter),y.push(T.minFilter),y.push(T.anisotropy),y.push(T.internalFormat),y.push(T.format),y.push(T.type),y.push(T.generateMipmaps),y.push(T.premultiplyAlpha),y.push(T.flipY),y.push(T.unpackAlignment),y.push(T.colorSpace),y.join()}function V(T,y){const F=n.get(T);if(T.isVideoTexture&&Se(T),T.isRenderTargetTexture===!1&&T.version>0&&F.__version!==T.version){const K=T.image;if(K===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{j(F,T,y);return}}t.bindTexture(r.TEXTURE_2D,F.__webglTexture,r.TEXTURE0+y)}function W(T,y){const F=n.get(T);if(T.version>0&&F.__version!==T.version){j(F,T,y);return}t.bindTexture(r.TEXTURE_2D_ARRAY,F.__webglTexture,r.TEXTURE0+y)}function Y(T,y){const F=n.get(T);if(T.version>0&&F.__version!==T.version){j(F,T,y);return}t.bindTexture(r.TEXTURE_3D,F.__webglTexture,r.TEXTURE0+y)}function H(T,y){const F=n.get(T);if(T.version>0&&F.__version!==T.version){ee(F,T,y);return}t.bindTexture(r.TEXTURE_CUBE_MAP,F.__webglTexture,r.TEXTURE0+y)}const te={[kt]:r.REPEAT,[Tn]:r.CLAMP_TO_EDGE,[ps]:r.MIRRORED_REPEAT},ce={[Et]:r.NEAREST,[eo]:r.NEAREST_MIPMAP_NEAREST,[Ei]:r.NEAREST_MIPMAP_LINEAR,[Ut]:r.LINEAR,[hs]:r.LINEAR_MIPMAP_NEAREST,[ln]:r.LINEAR_MIPMAP_LINEAR},_e={[Vh]:r.NEVER,[Kh]:r.ALWAYS,[Wh]:r.LESS,[Fc]:r.LEQUAL,[Xh]:r.EQUAL,[Yh]:r.GEQUAL,[qh]:r.GREATER,[jh]:r.NOTEQUAL};function Ne(T,y){if(y.type===nn&&e.has("OES_texture_float_linear")===!1&&(y.magFilter===Ut||y.magFilter===hs||y.magFilter===Ei||y.magFilter===ln||y.minFilter===Ut||y.minFilter===hs||y.minFilter===Ei||y.minFilter===ln)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(T,r.TEXTURE_WRAP_S,te[y.wrapS]),r.texParameteri(T,r.TEXTURE_WRAP_T,te[y.wrapT]),(T===r.TEXTURE_3D||T===r.TEXTURE_2D_ARRAY)&&r.texParameteri(T,r.TEXTURE_WRAP_R,te[y.wrapR]),r.texParameteri(T,r.TEXTURE_MAG_FILTER,ce[y.magFilter]),r.texParameteri(T,r.TEXTURE_MIN_FILTER,ce[y.minFilter]),y.compareFunction&&(r.texParameteri(T,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(T,r.TEXTURE_COMPARE_FUNC,_e[y.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===Et||y.minFilter!==Ei&&y.minFilter!==ln||y.type===nn&&e.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||n.get(y).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");r.texParameterf(T,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,i.getMaxAnisotropy())),n.get(y).__currentAnisotropy=y.anisotropy}}}function et(T,y){let F=!1;T.__webglInit===void 0&&(T.__webglInit=!0,y.addEventListener("dispose",w));const K=y.source;let Z=d.get(K);Z===void 0&&(Z={},d.set(K,Z));const q=X(y);if(q!==T.__cacheKey){Z[q]===void 0&&(Z[q]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,F=!0),Z[q].usedTimes++;const xe=Z[T.__cacheKey];xe!==void 0&&(Z[T.__cacheKey].usedTimes--,xe.usedTimes===0&&M(y)),T.__cacheKey=q,T.__webglTexture=Z[q].texture}return F}function j(T,y,F){let K=r.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(K=r.TEXTURE_2D_ARRAY),y.isData3DTexture&&(K=r.TEXTURE_3D);const Z=et(T,y),q=y.source;t.bindTexture(K,T.__webglTexture,r.TEXTURE0+F);const xe=n.get(q);if(q.version!==xe.__version||Z===!0){t.activeTexture(r.TEXTURE0+F);const re=ke.getPrimaries(ke.workingColorSpace),he=y.colorSpace===En?null:ke.getPrimaries(y.colorSpace),We=y.colorSpace===En||re===he?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,y.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,y.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,We);let J=_(y.image,!1,i.maxTextureSize);J=it(y,J);const ue=s.convert(y.format,y.colorSpace),Ee=s.convert(y.type);let we=E(y.internalFormat,ue,Ee,y.colorSpace,y.isVideoTexture);Ne(K,y);let de;const Ge=y.mipmaps,De=y.isVideoTexture!==!0,tt=xe.__version===void 0||Z===!0,P=q.dataReady,ie=L(y,J);if(y.isDepthTexture)we=x(y.format===Oi,y.type),tt&&(De?t.texStorage2D(r.TEXTURE_2D,1,we,J.width,J.height):t.texImage2D(r.TEXTURE_2D,0,we,J.width,J.height,0,ue,Ee,null));else if(y.isDataTexture)if(Ge.length>0){De&&tt&&t.texStorage2D(r.TEXTURE_2D,ie,we,Ge[0].width,Ge[0].height);for(let G=0,$=Ge.length;G<$;G++)de=Ge[G],De?P&&t.texSubImage2D(r.TEXTURE_2D,G,0,0,de.width,de.height,ue,Ee,de.data):t.texImage2D(r.TEXTURE_2D,G,we,de.width,de.height,0,ue,Ee,de.data);y.generateMipmaps=!1}else De?(tt&&t.texStorage2D(r.TEXTURE_2D,ie,we,J.width,J.height),P&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,J.width,J.height,ue,Ee,J.data)):t.texImage2D(r.TEXTURE_2D,0,we,J.width,J.height,0,ue,Ee,J.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){De&&tt&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ie,we,Ge[0].width,Ge[0].height,J.depth);for(let G=0,$=Ge.length;G<$;G++)if(de=Ge[G],y.format!==Ht)if(ue!==null)if(De){if(P)if(y.layerUpdates.size>0){const le=Ul(de.width,de.height,y.format,y.type);for(const ae of y.layerUpdates){const Ie=de.data.subarray(ae*le/de.data.BYTES_PER_ELEMENT,(ae+1)*le/de.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,G,0,0,ae,de.width,de.height,1,ue,Ie)}y.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,G,0,0,0,de.width,de.height,J.depth,ue,de.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,G,we,de.width,de.height,J.depth,0,de.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else De?P&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,G,0,0,0,de.width,de.height,J.depth,ue,Ee,de.data):t.texImage3D(r.TEXTURE_2D_ARRAY,G,we,de.width,de.height,J.depth,0,ue,Ee,de.data)}else{De&&tt&&t.texStorage2D(r.TEXTURE_2D,ie,we,Ge[0].width,Ge[0].height);for(let G=0,$=Ge.length;G<$;G++)de=Ge[G],y.format!==Ht?ue!==null?De?P&&t.compressedTexSubImage2D(r.TEXTURE_2D,G,0,0,de.width,de.height,ue,de.data):t.compressedTexImage2D(r.TEXTURE_2D,G,we,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):De?P&&t.texSubImage2D(r.TEXTURE_2D,G,0,0,de.width,de.height,ue,Ee,de.data):t.texImage2D(r.TEXTURE_2D,G,we,de.width,de.height,0,ue,Ee,de.data)}else if(y.isDataArrayTexture)if(De){if(tt&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ie,we,J.width,J.height,J.depth),P)if(y.layerUpdates.size>0){const G=Ul(J.width,J.height,y.format,y.type);for(const $ of y.layerUpdates){const le=J.data.subarray($*G/J.data.BYTES_PER_ELEMENT,($+1)*G/J.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,$,J.width,J.height,1,ue,Ee,le)}y.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,ue,Ee,J.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,we,J.width,J.height,J.depth,0,ue,Ee,J.data);else if(y.isData3DTexture)De?(tt&&t.texStorage3D(r.TEXTURE_3D,ie,we,J.width,J.height,J.depth),P&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,ue,Ee,J.data)):t.texImage3D(r.TEXTURE_3D,0,we,J.width,J.height,J.depth,0,ue,Ee,J.data);else if(y.isFramebufferTexture){if(tt)if(De)t.texStorage2D(r.TEXTURE_2D,ie,we,J.width,J.height);else{let G=J.width,$=J.height;for(let le=0;le<ie;le++)t.texImage2D(r.TEXTURE_2D,le,we,G,$,0,ue,Ee,null),G>>=1,$>>=1}}else if(Ge.length>0){if(De&&tt){const G=be(Ge[0]);t.texStorage2D(r.TEXTURE_2D,ie,we,G.width,G.height)}for(let G=0,$=Ge.length;G<$;G++)de=Ge[G],De?P&&t.texSubImage2D(r.TEXTURE_2D,G,0,0,ue,Ee,de):t.texImage2D(r.TEXTURE_2D,G,we,ue,Ee,de);y.generateMipmaps=!1}else if(De){if(tt){const G=be(J);t.texStorage2D(r.TEXTURE_2D,ie,we,G.width,G.height)}P&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,ue,Ee,J)}else t.texImage2D(r.TEXTURE_2D,0,we,ue,Ee,J);m(y)&&p(K),xe.__version=q.version,y.onUpdate&&y.onUpdate(y)}T.__version=y.version}function ee(T,y,F){if(y.image.length!==6)return;const K=et(T,y),Z=y.source;t.bindTexture(r.TEXTURE_CUBE_MAP,T.__webglTexture,r.TEXTURE0+F);const q=n.get(Z);if(Z.version!==q.__version||K===!0){t.activeTexture(r.TEXTURE0+F);const xe=ke.getPrimaries(ke.workingColorSpace),re=y.colorSpace===En?null:ke.getPrimaries(y.colorSpace),he=y.colorSpace===En||xe===re?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,y.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,y.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,he);const We=y.isCompressedTexture||y.image[0].isCompressedTexture,J=y.image[0]&&y.image[0].isDataTexture,ue=[];for(let $=0;$<6;$++)!We&&!J?ue[$]=_(y.image[$],!0,i.maxCubemapSize):ue[$]=J?y.image[$].image:y.image[$],ue[$]=it(y,ue[$]);const Ee=ue[0],we=s.convert(y.format,y.colorSpace),de=s.convert(y.type),Ge=E(y.internalFormat,we,de,y.colorSpace),De=y.isVideoTexture!==!0,tt=q.__version===void 0||K===!0,P=Z.dataReady;let ie=L(y,Ee);Ne(r.TEXTURE_CUBE_MAP,y);let G;if(We){De&&tt&&t.texStorage2D(r.TEXTURE_CUBE_MAP,ie,Ge,Ee.width,Ee.height);for(let $=0;$<6;$++){G=ue[$].mipmaps;for(let le=0;le<G.length;le++){const ae=G[le];y.format!==Ht?we!==null?De?P&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,le,0,0,ae.width,ae.height,we,ae.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,le,Ge,ae.width,ae.height,0,ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):De?P&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,le,0,0,ae.width,ae.height,we,de,ae.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,le,Ge,ae.width,ae.height,0,we,de,ae.data)}}}else{if(G=y.mipmaps,De&&tt){G.length>0&&ie++;const $=be(ue[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,ie,Ge,$.width,$.height)}for(let $=0;$<6;$++)if(J){De?P&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,ue[$].width,ue[$].height,we,de,ue[$].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Ge,ue[$].width,ue[$].height,0,we,de,ue[$].data);for(let le=0;le<G.length;le++){const Ie=G[le].image[$].image;De?P&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,le+1,0,0,Ie.width,Ie.height,we,de,Ie.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,le+1,Ge,Ie.width,Ie.height,0,we,de,Ie.data)}}else{De?P&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,we,de,ue[$]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Ge,we,de,ue[$]);for(let le=0;le<G.length;le++){const ae=G[le];De?P&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,le+1,0,0,we,de,ae.image[$]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,le+1,Ge,we,de,ae.image[$])}}}m(y)&&p(r.TEXTURE_CUBE_MAP),q.__version=Z.version,y.onUpdate&&y.onUpdate(y)}T.__version=y.version}function ge(T,y,F,K,Z,q){const xe=s.convert(F.format,F.colorSpace),re=s.convert(F.type),he=E(F.internalFormat,xe,re,F.colorSpace),We=n.get(y),J=n.get(F);if(J.__renderTarget=y,!We.__hasExternalTextures){const ue=Math.max(1,y.width>>q),Ee=Math.max(1,y.height>>q);Z===r.TEXTURE_3D||Z===r.TEXTURE_2D_ARRAY?t.texImage3D(Z,q,he,ue,Ee,y.depth,0,xe,re,null):t.texImage2D(Z,q,he,ue,Ee,0,xe,re,null)}t.bindFramebuffer(r.FRAMEBUFFER,T),He(y)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,K,Z,J.__webglTexture,0,ze(y)):(Z===r.TEXTURE_2D||Z>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,K,Z,J.__webglTexture,q),t.bindFramebuffer(r.FRAMEBUFFER,null)}function se(T,y,F){if(r.bindRenderbuffer(r.RENDERBUFFER,T),y.depthBuffer){const K=y.depthTexture,Z=K&&K.isDepthTexture?K.type:null,q=x(y.stencilBuffer,Z),xe=y.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,re=ze(y);He(y)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,re,q,y.width,y.height):F?r.renderbufferStorageMultisample(r.RENDERBUFFER,re,q,y.width,y.height):r.renderbufferStorage(r.RENDERBUFFER,q,y.width,y.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,xe,r.RENDERBUFFER,T)}else{const K=y.textures;for(let Z=0;Z<K.length;Z++){const q=K[Z],xe=s.convert(q.format,q.colorSpace),re=s.convert(q.type),he=E(q.internalFormat,xe,re,q.colorSpace),We=ze(y);F&&He(y)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,We,he,y.width,y.height):He(y)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,We,he,y.width,y.height):r.renderbufferStorage(r.RENDERBUFFER,he,y.width,y.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Te(T,y){if(y&&y.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,T),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=n.get(y.depthTexture);K.__renderTarget=y,(!K.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),V(y.depthTexture,0);const Z=K.__webglTexture,q=ze(y);if(y.depthTexture.format===Ci)He(y)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Z,0,q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Z,0);else if(y.depthTexture.format===Oi)He(y)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Z,0,q):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Ce(T){const y=n.get(T),F=T.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==T.depthTexture){const K=T.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),K){const Z=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,K.removeEventListener("dispose",Z)};K.addEventListener("dispose",Z),y.__depthDisposeCallback=Z}y.__boundDepthTexture=K}if(T.depthTexture&&!y.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");Te(y.__webglFramebuffer,T)}else if(F){y.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(t.bindFramebuffer(r.FRAMEBUFFER,y.__webglFramebuffer[K]),y.__webglDepthbuffer[K]===void 0)y.__webglDepthbuffer[K]=r.createRenderbuffer(),se(y.__webglDepthbuffer[K],T,!1);else{const Z=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,q=y.__webglDepthbuffer[K];r.bindRenderbuffer(r.RENDERBUFFER,q),r.framebufferRenderbuffer(r.FRAMEBUFFER,Z,r.RENDERBUFFER,q)}}else if(t.bindFramebuffer(r.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=r.createRenderbuffer(),se(y.__webglDepthbuffer,T,!1);else{const K=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Z=y.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,Z),r.framebufferRenderbuffer(r.FRAMEBUFFER,K,r.RENDERBUFFER,Z)}t.bindFramebuffer(r.FRAMEBUFFER,null)}function Fe(T,y,F){const K=n.get(T);y!==void 0&&ge(K.__webglFramebuffer,T,T.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),F!==void 0&&Ce(T)}function lt(T){const y=T.texture,F=n.get(T),K=n.get(y);T.addEventListener("dispose",A);const Z=T.textures,q=T.isWebGLCubeRenderTarget===!0,xe=Z.length>1;if(xe||(K.__webglTexture===void 0&&(K.__webglTexture=r.createTexture()),K.__version=y.version,a.memory.textures++),q){F.__webglFramebuffer=[];for(let re=0;re<6;re++)if(y.mipmaps&&y.mipmaps.length>0){F.__webglFramebuffer[re]=[];for(let he=0;he<y.mipmaps.length;he++)F.__webglFramebuffer[re][he]=r.createFramebuffer()}else F.__webglFramebuffer[re]=r.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){F.__webglFramebuffer=[];for(let re=0;re<y.mipmaps.length;re++)F.__webglFramebuffer[re]=r.createFramebuffer()}else F.__webglFramebuffer=r.createFramebuffer();if(xe)for(let re=0,he=Z.length;re<he;re++){const We=n.get(Z[re]);We.__webglTexture===void 0&&(We.__webglTexture=r.createTexture(),a.memory.textures++)}if(T.samples>0&&He(T)===!1){F.__webglMultisampledFramebuffer=r.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let re=0;re<Z.length;re++){const he=Z[re];F.__webglColorRenderbuffer[re]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,F.__webglColorRenderbuffer[re]);const We=s.convert(he.format,he.colorSpace),J=s.convert(he.type),ue=E(he.internalFormat,We,J,he.colorSpace,T.isXRRenderTarget===!0),Ee=ze(T);r.renderbufferStorageMultisample(r.RENDERBUFFER,Ee,ue,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+re,r.RENDERBUFFER,F.__webglColorRenderbuffer[re])}r.bindRenderbuffer(r.RENDERBUFFER,null),T.depthBuffer&&(F.__webglDepthRenderbuffer=r.createRenderbuffer(),se(F.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(q){t.bindTexture(r.TEXTURE_CUBE_MAP,K.__webglTexture),Ne(r.TEXTURE_CUBE_MAP,y);for(let re=0;re<6;re++)if(y.mipmaps&&y.mipmaps.length>0)for(let he=0;he<y.mipmaps.length;he++)ge(F.__webglFramebuffer[re][he],T,y,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+re,he);else ge(F.__webglFramebuffer[re],T,y,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+re,0);m(y)&&p(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(xe){for(let re=0,he=Z.length;re<he;re++){const We=Z[re],J=n.get(We);t.bindTexture(r.TEXTURE_2D,J.__webglTexture),Ne(r.TEXTURE_2D,We),ge(F.__webglFramebuffer,T,We,r.COLOR_ATTACHMENT0+re,r.TEXTURE_2D,0),m(We)&&p(r.TEXTURE_2D)}t.unbindTexture()}else{let re=r.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(re=T.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(re,K.__webglTexture),Ne(re,y),y.mipmaps&&y.mipmaps.length>0)for(let he=0;he<y.mipmaps.length;he++)ge(F.__webglFramebuffer[he],T,y,r.COLOR_ATTACHMENT0,re,he);else ge(F.__webglFramebuffer,T,y,r.COLOR_ATTACHMENT0,re,0);m(y)&&p(re),t.unbindTexture()}T.depthBuffer&&Ce(T)}function Ve(T){const y=T.textures;for(let F=0,K=y.length;F<K;F++){const Z=y[F];if(m(Z)){const q=S(T),xe=n.get(Z).__webglTexture;t.bindTexture(q,xe),p(q),t.unbindTexture()}}}const ht=[],N=[];function Vt(T){if(T.samples>0){if(He(T)===!1){const y=T.textures,F=T.width,K=T.height;let Z=r.COLOR_BUFFER_BIT;const q=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,xe=n.get(T),re=y.length>1;if(re)for(let he=0;he<y.length;he++)t.bindFramebuffer(r.FRAMEBUFFER,xe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+he,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,xe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+he,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,xe.__webglMultisampledFramebuffer),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,xe.__webglFramebuffer);for(let he=0;he<y.length;he++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Z|=r.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Z|=r.STENCIL_BUFFER_BIT)),re){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,xe.__webglColorRenderbuffer[he]);const We=n.get(y[he]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,We,0)}r.blitFramebuffer(0,0,F,K,0,0,F,K,Z,r.NEAREST),l===!0&&(ht.length=0,N.length=0,ht.push(r.COLOR_ATTACHMENT0+he),T.depthBuffer&&T.resolveDepthBuffer===!1&&(ht.push(q),N.push(q),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,N)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,ht))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),re)for(let he=0;he<y.length;he++){t.bindFramebuffer(r.FRAMEBUFFER,xe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+he,r.RENDERBUFFER,xe.__webglColorRenderbuffer[he]);const We=n.get(y[he]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,xe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+he,r.TEXTURE_2D,We,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,xe.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const y=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[y])}}}function ze(T){return Math.min(i.maxSamples,T.samples)}function He(T){const y=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function Se(T){const y=a.render.frame;h.get(T)!==y&&(h.set(T,y),T.update())}function it(T,y){const F=T.colorSpace,K=T.format,Z=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||F!==Lt&&F!==En&&(ke.getTransfer(F)===Je?(K!==Ht||Z!==Cn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),y}function be(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=O,this.resetTextureUnits=z,this.setTexture2D=V,this.setTexture2DArray=W,this.setTexture3D=Y,this.setTextureCube=H,this.rebindTextures=Fe,this.setupRenderTarget=lt,this.updateRenderTargetMipmap=Ve,this.updateMultisampleRenderTarget=Vt,this.setupDepthRenderbuffer=Ce,this.setupFrameBufferTexture=ge,this.useMultisampledRTT=He}function mg(r,e){function t(n,i=En){let s;const a=ke.getTransfer(i);if(n===Cn)return r.UNSIGNED_BYTE;if(n===no)return r.UNSIGNED_SHORT_4_4_4_4;if(n===io)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Rc)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===wc)return r.BYTE;if(n===Ac)return r.SHORT;if(n===ms)return r.UNSIGNED_SHORT;if(n===to)return r.INT;if(n===ni)return r.UNSIGNED_INT;if(n===nn)return r.FLOAT;if(n===_s)return r.HALF_FLOAT;if(n===Cc)return r.ALPHA;if(n===Lc)return r.RGB;if(n===Ht)return r.RGBA;if(n===Ic)return r.LUMINANCE;if(n===Pc)return r.LUMINANCE_ALPHA;if(n===Ci)return r.DEPTH_COMPONENT;if(n===Oi)return r.DEPTH_STENCIL;if(n===so)return r.RED;if(n===ro)return r.RED_INTEGER;if(n===Dc)return r.RG;if(n===ao)return r.RG_INTEGER;if(n===oo)return r.RGBA_INTEGER;if(n===Js||n===Qs||n===er||n===tr)if(a===Je)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Js)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Qs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===er)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===tr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Js)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Qs)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===er)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===tr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ga||n===_a||n===xa||n===va)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===ga)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===_a)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===xa)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===va)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ya||n===Ma||n===ba)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ya||n===Ma)return a===Je?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===ba)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Sa||n===Ea||n===Ta||n===wa||n===Aa||n===Ra||n===Ca||n===La||n===Ia||n===Pa||n===Da||n===Ua||n===Na||n===Fa)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Sa)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ea)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ta)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===wa)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Aa)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Ra)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ca)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===La)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ia)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Pa)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Da)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ua)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Na)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Fa)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===nr||n===Oa||n===Ba)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===nr)return a===Je?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Oa)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ba)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Uc||n===ka||n===za||n===Ha)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===nr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===ka)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===za)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ha)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Fi?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}class gg extends At{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class An extends ot{constructor(){super(),this.isGroup=!0,this.type="Group"}}const _g={type:"move"};class Xr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new An,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new An,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new C,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new C),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new An,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new C,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new C),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const _ of e.hand.values()){const m=t.getJointPose(_,n),p=this._getHandJoint(c,_);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),f=.02,g=.005;c.inputState.pinching&&d>f+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=f-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(o.matrix.fromArray(i.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,i.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(i.linearVelocity)):o.hasLinearVelocity=!1,i.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(i.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(_g)))}return o!==null&&(o.visible=i!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new An;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const xg=`
void main() {
...
`);navigator.clipboard.writeText(e).then(()=>{const t=document.getElementById("copy-all-text-btn");t.innerText="✅ تم نسخ النص بنجاح!",setTimeout(()=>{t.innerText="📋 نسخ الترجمة كاملة"},2500)})}),document.getElementById("ambient-audio-btn").addEventListener("click",()=>{this.toggleAmbientSound()})}open(){this.backdrop.classList.remove("hidden"),document.body.style.overflow="hidden";const e=document.getElementById("mob-reader-btn");e&&e.classList.add("active");const t=document.getElementById("open-reader-btn");t&&t.classList.add("active")}close(){this.backdrop.classList.add("hidden"),document.body.style.overflow="";const e=document.getElementById("mob-reader-btn");e&&e.classList.remove("active");const t=document.getElementById("open-reader-btn");t&&t.classList.remove("active")}renderDataset(e){document.getElementById("reader-tablet-title").innerText=e.title,document.getElementById("reader-tablet-meta").innerText=`${e.museumId} • ${e.period} • ${e.date}`,document.getElementById("reader-tablet-desc").innerText=e.description,this.linesContainer.innerHTML=e.lines.map((t,n)=>`
    ...
    `;document.getElementById("app").insertAdjacentHTML("beforeend",e)}bindEvents(){const e=document.querySelector(".controls-sidebar"),t=document.getElementById("floating-sidebar-toggle-btn"),n=document.getElementById("toggle-sidebar-btn"),i=M=>{M!==void 0?M?e.classList.remove("collapsed"):e.classList.add("collapsed"):e.classList.toggle("collapsed");const v=e.classList.contains("collapsed");t.style.display=v?"flex":"none";const R=document.getElementById("mob-sidebar-btn");R&&(v?R.classList.remove("active"):R.classList.add("active"))};t.addEventListener("click",()=>i(!0)),n.addEventListener("click",()=>i(!1)),document.getElementById("mob-sidebar-btn").addEventListener("click",()=>{e.classList.contains("collapsed")?(this.drawingToolbar.isOpen&&this.drawingToolbar.close(),i(!0)):i(!1)}),document.getElementById("mob-drawing-btn").addEventListener("click",()=>{this.drawingToolbar.isOpen?this.drawingToolbar.close():(i(!1),this.drawingToolbar.open())}),document.getElementById("mob-reader-btn").addEventListener("click",()=>{this.readerModal.backdrop.classList.contains("hidden")?(i(!1),this.drawingToolbar.isOpen&&this.drawingToolbar.close(),this.readerModal.open()):this.readerModal.close()}),document.getElementById("mob-dict-btn").addEventListener("click",()=>{this.signDictionaryModal.backdrop.classList.contains("hidden")?(i(!1),this.drawingToolbar.isOpen&&this.drawingToolbar.close(),this.signDictionaryModal.open()):this.signDictionaryModal.close()}),document.getElementById("mob-flip-btn").addEventListener("click",()=>{this.viewer.flipTabletTo("toggle")});const s=document.getElementById("switch-ur-tablet-btn"),a=document.getElementById("switch-cylinder-btn");s&&s.addEventListener("click",()=>{s.classList.add("active"),a&&a.classList.remove("active"),this.viewer.loadAuthenticUrTablet()}),a&&a.addEventListener("click",()=>{a.classList.add("active"),s&&s.classList.remove("active"),this.viewer.loadCylinderModel()});const o=()=>{this.drawingToolbar.isOpen?this.drawingToolbar.close():(i(!1),this.drawingToolbar.open())};document.getElementById("open-drawing-btn").addEventListener("click",o),document.getElementById("sidebar-draw-btn").addEventListener("click",o),document.getElementById("open-reader-btn").addEventListener("click",()=>{this.readerModal.open()}),document.getElementById("open-dictionary-btn").addEventListener("click",()=>{this.signDictionaryModal.open()});const l=document.getElementById("toggle-loupe-btn");l.addEventListener("click",()=>{const M=!this.magnifierLoupe.active;this.magnifierLoupe.setActive(M),l.classList.toggle("active",M)});const c=()=>{this.isMacroActive=!this.isMacroActive,this.viewer.toggleSuperMacro(this.isMacroActive);const M=this.isMacroActive?"🔎 خروج من التقريب الفائق":"🔎 تقريب فائق (Super Macro)",v=document.getElementById("macro-btn-label");v&&(v.innerText=M);const R=document.getElementById("macro-bottom-btn");R&&(R.innerText=this.isMacroActive?"🔍 خروج من الماكرو":"🔍 تقريب فائق")};document.getElementById("sidebar-macro-btn").addEventListener("click",c);const h=document.getElementById("macro-bottom-btn");h&&h.addEventListener("click",c);let u=!1;document.getElementById("sidebar-lineart-btn").addEventListener("click",()=>{u=!u,this.viewer.setBinarizationMode(u),document.getElementById("sidebar-lineart-btn").classList.toggle("active",u),document.getElementById("lineart-btn-label").innerText=u?"🔲 إلغاء نمط الرسم الخطي":"🔲 نمط الرسم الخطي (B/W)"}),document.getElementById("flip-tablet-btn").addEventListener("click",()=>{this.viewer.flipTabletTo("toggle")});const d=document.getElementById("reset-cam-btn");d&&d.addEventListener("click",()=>{this.isMacroActive=!1,this.viewer.resetCameraView()}),document.getElementById("snapshot-btn").addEventListener("click",()=>{this.viewer.takeSnapshot()});const f=M=>{if(!M)return;this.viewer.loadCustomFile(M);const v=document.getElementById("current-model-name");v&&(v.innerText=M.name)};document.getElementById("custom-model-input").addEventListener("change",M=>{M.target.files.length>0&&f(M.target.files[0])}),document.getElementById("custom-model-input-sidebar").addEventListener("change",M=>{M.target.files.length>0&&f(M.target.files[0])}),document.getElementById("export-glb-btn").addEventListener("click",()=>{if(!this.viewer.tabletMesh)return;new cr().parse(this.viewer.tabletMesh,v=>{const R=new Blob([v],{type:"application/octet-stream"}),z=document.createElement("a");z.href=URL.createObjectURL(R),z.download=`cuneiform_tablet_${Date.now()}.glb`,z.click()},v=>console.error("Error exporting GLB:",v),{binary:!0})});const g=document.getElementById("virtual-dome"),_=M=>{if(!this.isDraggingDome)return;const v=g.getBoundingClientRect(),R=M.touches?M.touches[0].clientX:M.clientX,z=M.touches?M.touches[0].clientY:M.clientY,O=v.left+v.width/2,X=v.top+v.height/2,V=R-O,W=z-X,Y=v.width/2,H=Math.min(Y,Math.sqrt(V*V+W*W));let te=Math.atan2(V,-W);te<0&&(te+=Math.PI*2);const ce=Math.round(te*180/Math.PI),_e=Math.round(90-H/Y*85);this.viewer.lighting.setDirection(ce,_e),this.updateDomeHandle(ce,_e),this.updateSlidersFromLighting()};g.addEventListener("mousedown",M=>{this.isDraggingDome=!0,_(M)}),window.addEventListener("mousemove",_),window.addEventListener("mouseup",()=>{this.isDraggingDome=!1}),g.addEventListener("touchstart",M=>{this.isDraggingDome=!0,_(M)},{passive:!0}),window.addEventListener("touchmove",_,{passive:!0}),window.addEventListener("touchend",()=>{this.isDraggingDome=!1}),document.getElementById("elevation-slider").addEventListener("input",M=>{const v=parseFloat(M.target.value);this.viewer.lighting.setDirection(this.viewer.lighting.azimuth,v),document.getElementById("elevation-val").innerText=`${v}°`,this.updateDomeHandle(this.viewer.lighting.azimuth,v)}),document.getElementById("intensity-slider").addEventListener("input",M=>{const v=parseFloat(M.target.value);this.viewer.lighting.setIntensity(v),document.getElementById("intensity-val").innerText=`${v.toFixed(1)}x`}),document.getElementById("shadow-slider").addEventListener("input",M=>{const v=parseFloat(M.target.value);this.viewer.lighting.setShadowDarkness(v),document.getElementById("shadow-val").innerText=`${Math.round(v*100)}%`}),document.getElementById("relief-slider").addEventListener("input",M=>{const v=parseFloat(M.target.value);this.viewer.builder.setReliefScale(v),document.getElementById("relief-val").innerText=`${v.toFixed(1)}x`}),document.getElementById("kelvin-slider").addEventListener("input",M=>{const v=parseInt(M.target.value,10);this.viewer.lighting.setColorTemperature(v),document.getElementById("kelvin-val").innerText=`${v}K`}),document.querySelectorAll(".preset-card").forEach(M=>{M.addEventListener("click",()=>{const v=M.getAttribute("data-preset-id"),R=pc.find(z=>z.id===v);R&&(document.querySelectorAll(".preset-card").forEach(z=>z.classList.remove("active")),M.classList.add("active"),this.viewer.lighting.applyPreset(R),this.viewer.setDepthAnalysisMode(!!R.isDepthMode),R.reliefMultiplier&&this.viewer.builder.setReliefScale(R.reliefMultiplier),this.updateSlidersFromLighting(),this.updateDomeHandle(this.viewer.lighting.azimuth,this.viewer.lighting.elevation))})}),document.querySelectorAll(".flip-btn").forEach(M=>{M.addEventListener("click",()=>{const v=M.getAttribute("data-side");this.viewer.flipTabletTo(v)})}),document.getElementById("show-helpers-chk").addEventListener("change",M=>{this.viewer.lighting.setHelpersVisible(M.target.checked)}),document.getElementById("torch-mode-chk").addEventListener("change",M=>{this.viewer.lighting.setTorchMode(M.target.checked)});const L=document.getElementById("phone-qr-modal"),w=document.getElementById("open-phone-qr-btn"),A=document.getElementById("close-phone-qr-btn"),I=document.getElementById("copy-qr-link-btn");w&&L&&w.addEventListener("click",()=>{L.classList.remove("hidden")}),A&&L&&A.addEventListener("click",()=>{L.classList.add("hidden")}),L&&L.addEventListener("click",M=>{M.target===L&&L.classList.add("hidden")}),I&&I.addEventListener("click",()=>{navigator.clipboard.writeText("https://aqy31.github.io/Cuneiform-/").then(()=>{I.innerHTML="<span>✅ تم نسخ الرابط بنجاح!</span>",setTimeout(()=>{I.innerHTML="<span>📋 نسخ الرابط المباشر</span>"},2500)})})}updateDomeHandle(e,t){const n=document.getElementById("virtual-dome"),i=document.getElementById("dome-sun-handle");if(!n||!i)return;const s=n.clientWidth/2,a=(90-t)/85*(s-12),o=e*Math.PI/180,l=s+a*Math.sin(o),c=s-a*Math.cos(o);i.style.left=`${l}px`,i.style.top=`${c}px`;const h=document.getElementById("light-angle-badge");h&&(h.innerText=`${e}° / ${t}°`)}updateSlidersFromLighting(){const e=this.viewer.lighting,t=document.getElementById("elevation-slider");t&&(t.value=e.elevation),document.getElementById("elevation-val").innerText=`${e.elevation}°`;const n=document.getElementById("intensity-slider");n&&(n.value=e.intensity),document.getElementById("intensity-val").innerText=`${e.intensity.toFixed(1)}x`;const i=document.getElementById("kelvin-slider");i&&(i.value=e.colorTemp),document.getElementById("kelvin-val").innerText=`${e.colorTemp}K`;const s=document.getElementById("shadow-slider");s&&(s.value=e.shadowDarkness),document.getElementById("shadow-val").innerText=`${Math.round(e.shadowDarkness*100)}%`}}class V0{constructor(e){this.viewer=e,this.active=!1,this.cameraLocked=!0,this.tool="pen",this.color="#0a0a0a",this.lineWidth=6,this.opacity=1,this.textureSize=2048,this.drawingCanvas=document.createElement("canvas"),this.drawingCanvas.width=this.textureSize,this.drawingCanvas.height=this.textureSize,this.ctx=this.drawingCanvas.getContext("2d"),this.drawingTexture=new bi(this.drawingCanvas),this.drawingTexture.anisotropy=8,this.overlayMeshes=[],this.isDrawing=!1,this.prevUV=null,this.prevPoint=null,this.pointsBuffer=[],this.softness=.75,this.strokeHistory=[],this.undoStack=[],this.initReticle(),this.initEvents()}setSoftness(e){this.softness=Math.max(0,Math.min(1,e))}initReticle(){const e=new xo(.04,.055,32),t=new cn({color:13938487,side:zt,depthTest:!1,transparent:!0,opacity:.8});this.reticle=new pt(e,t),this.reticle.visible=!1,this.reticle.renderOrder=999,this.viewer.scene.add(this.reticle)}attachToModel(e){if(this.removeOverlayMeshes(),!e)return null;const t=new Yt().setFromObject(e),n=new C,i=new C;t.getSize(n),t.getCenter(i),this.modelDimensions={width:(n.x*10).toFixed(1),height:(n.y*10).toFixed(1),depth:(n.z*10).toFixed(1),rawSize:n,center:i};const s=[];e.traverse(a=>{a.isMesh&&a.geometry&&a.name!=="DrawingSurfaceOverlay"&&s.push(a)});for(const a of s){this.ensureUVCoordinates(a.geometry);const o=new cn({map:this.drawingTexture,transparent:!0,opacity:this.opacity,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-4,side:zt}),l=new pt(a.geometry,o);l.name="DrawingSurfaceOverlay",a.add(l),this.overlayMeshes.push(l)}return this.modelDimensions}ensureUVCoordinates(e){if(!e.attributes.uv){const t=e.attributes.position,n=new Float32Array(t.count*2),i=e.boundingBox||new Yt().setFromBufferAttribute(t),s=i.max.x-i.min.x||1,a=i.max.y-i.min.y||1;for(let o=0;o<t.count;o++){const l=t.getX(o),c=t.getY(o);n[o*2]=(l-i.min.x)/s,n[o*2+1]=(c-i.min.y)/a}e.setAttribute("uv",new at(n,2))}}removeOverlayMeshes(){this.overlayMeshes.forEach(e=>{e.parent&&e.parent.remove(e),e.material&&e.material.dispose()}),this.overlayMeshes=[]}setActive(e){this.active=e,this.reticle.visible=e,this.viewer.controls.enabled=!this.cameraLocked||!e;const t=this.viewer.renderer.domElement;e?t.style.cursor="crosshair":t.style.cursor="default"}setCameraLock(e){this.cameraLocked=e,this.active&&(this.viewer.controls.enabled=!e)}setTool(e){this.tool=e}setColor(e){this.color=e}setLineWidth(e){this.lineWidth=e}setOpacity(e){this.opacity=e,this.overlayMeshes.forEach(t=>{t.material&&(t.material.opacity=e)})}initEvents(){const e=this.viewer.renderer.domElement,t=i=>{if(!this.viewer.tabletMesh)return null;const s=e.getBoundingClientRect(),a=i.touches?i.touches[0].clientX:i.clientX,o=i.touches?i.touches[0].clientY:i.clientY,l=new Me((a-s.left)/s.width*2-1,-((o-s.top)/s.height)*2+1);return this.viewer.raycaster.setFromCamera(l,this.viewer.camera),this.viewer.raycaster.intersectObject(this.viewer.tabletMesh,!0).find(u=>u.object.name!=="DrawingSurfaceOverlay")||null};e.addEventListener("pointermove",i=>{if(!this.active)return;const s=t(i);if(s&&s.point&&s.face){this.reticle.visible=!0,this.reticle.position.copy(s.point);const a=new Le().getNormalMatrix(s.object.matrixWorld),o=s.face.normal.clone().applyMatrix3(a).normalize();this.reticle.quaternion.setFromUnitVectors(new C(0,0,1),o),this.reticle.position.addScaledVector(o,.012),this.isDrawing&&s.uv&&this.cameraLocked&&this.paintAtUV(s.uv,s.point)}else this.reticle.visible=!1,this.isDrawing&&(this.prevUV=null,this.prevPoint=null)}),e.addEventListener("pointerdown",i=>{if(!this.active||!this.cameraLocked||i.button!==0)return;const s=t(i);s&&s.uv&&(this.isDrawing=!0,this.prevPoint=s.point?s.point.clone():null,this.saveStateToUndo(),this.startStrokeAtUV(s.uv,s.point))});const n=()=>{this.isDrawing&&(this.isDrawing=!1,this.prevUV=null,this.prevPoint=null,this.pointsBuffer=[],this.strokeStartUV=null)};window.addEventListener("pointerup",n),e.addEventListener("pointerleave",()=>{this.reticle.visible=!1,this.isDrawing&&(this.prevUV=null,this.prevPoint=null)})}saveStateToUndo(){const e=this.ctx.getImageData(0,0,this.textureSize,this.textureSize);this.undoStack.push(e),this.undoStack.length>20&&this.undoStack.shift()}undo(){if(this.undoStack.length>0){const e=this.undoStack.pop();this.ctx.putImageData(e,0,0),this.drawingTexture.needsUpdate=!0}}clear(){this.saveStateToUndo(),this.ctx.clearRect(0,0,this.textureSize,this.textureSize),this.drawingTexture.needsUpdate=!0}drawSoftSegment(e,t,n,i){const s=this.lineWidth*2;this.softness>.05?(this.ctx.save(),this.ctx.globalCompositeOperation="source-over",this.ctx.globalAlpha=.24*this.softness,this.ctx.strokeStyle=this.color,this.ctx.lineWidth=s*(1.4+this.softness*.9),this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.shadowBlur=s*(2.4*this.softness),this.ctx.shadowColor=this.color,this.ctx.beginPath(),this.ctx.moveTo(e,t),this.ctx.lineTo(n,i),this.ctx.stroke(),this.ctx.restore(),this.ctx.save(),this.ctx.globalCompositeOperation="source-over",this.ctx.globalAlpha=.58,this.ctx.strokeStyle=this.color,this.ctx.lineWidth=s*(1.05+this.softness*.3),this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.shadowBlur=s*(.9*this.softness),this.ctx.shadowColor=this.color,this.ctx.beginPath(),this.ctx.moveTo(e,t),this.ctx.lineTo(n,i),this.ctx.stroke(),this.ctx.restore(),this.ctx.save(),this.ctx.globalCompositeOperation="source-over",this.ctx.globalAlpha=.92,this.ctx.strokeStyle=this.color,this.ctx.lineWidth=s*(1-this.softness*.22),this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.beginPath(),this.ctx.moveTo(e,t),this.ctx.lineTo(n,i),this.ctx.stroke(),this.ctx.restore()):(this.ctx.save(),this.ctx.globalCompositeOperation="source-over",this.ctx.strokeStyle=this.color,this.ctx.lineWidth=s,this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.beginPath(),this.ctx.moveTo(e,t),this.ctx.lineTo(n,i),this.ctx.stroke(),this.ctx.restore())}drawSoftCurve(e,t,n){const i=this.lineWidth*2,s={x:(e.x+t.x)/2,y:(e.y+t.y)/2},a={x:(t.x+n.x)/2,y:(t.y+n.y)/2};this.softness>.05?(this.ctx.save(),this.ctx.globalCompositeOperation="source-over",this.ctx.globalAlpha=.24*this.softness,this.ctx.strokeStyle=this.color,this.ctx.lineWidth=i*(1.4+this.softness*.9),this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.shadowBlur=i*(2.4*this.softness),this.ctx.shadowColor=this.color,this.ctx.beginPath(),this.ctx.moveTo(s.x,s.y),this.ctx.quadraticCurveTo(t.x,t.y,a.x,a.y),this.ctx.stroke(),this.ctx.restore(),this.ctx.save(),this.ctx.globalCompositeOperation="source-over",this.ctx.globalAlpha=.58,this.ctx.strokeStyle=this.color,this.ctx.lineWidth=i*(1.05+this.softness*.3),this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.shadowBlur=i*(.9*this.softness),this.ctx.shadowColor=this.color,this.ctx.beginPath(),this.ctx.moveTo(s.x,s.y),this.ctx.quadraticCurveTo(t.x,t.y,a.x,a.y),this.ctx.stroke(),this.ctx.restore(),this.ctx.save(),this.ctx.globalCompositeOperation="source-over",this.ctx.globalAlpha=.92,this.ctx.strokeStyle=this.color,this.ctx.lineWidth=i*(1-this.softness*.22),this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.beginPath(),this.ctx.moveTo(s.x,s.y),this.ctx.quadraticCurveTo(t.x,t.y,a.x,a.y),this.ctx.stroke(),this.ctx.restore()):(this.ctx.save(),this.ctx.globalCompositeOperation="source-over",this.ctx.strokeStyle=this.color,this.ctx.lineWidth=i,this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.beginPath(),this.ctx.moveTo(s.x,s.y),this.ctx.quadraticCurveTo(t.x,t.y,a.x,a.y),this.ctx.stroke(),this.ctx.restore())}drawSoftDot(e,t,n){this.softness>.05?(this.ctx.save(),this.ctx.fillStyle=this.color,this.ctx.globalAlpha=.24*this.softness,this.ctx.shadowBlur=n*(2.4*this.softness),this.ctx.shadowColor=this.color,this.ctx.beginPath(),this.ctx.arc(e,t,n*(1.4+this.softness*.9),0,Math.PI*2),this.ctx.fill(),this.ctx.restore(),this.ctx.save(),this.ctx.fillStyle=this.color,this.ctx.globalAlpha=.58,this.ctx.shadowBlur=n*(.9*this.softness),this.ctx.shadowColor=this.color,this.ctx.beginPath(),this.ctx.arc(e,t,n*(1.05+this.softness*.3),0,Math.PI*2),this.ctx.fill(),this.ctx.restore(),this.ctx.save(),this.ctx.fillStyle=this.color,this.ctx.globalAlpha=.92,this.ctx.beginPath(),this.ctx.arc(e,t,n*(1-this.softness*.22),0,Math.PI*2),this.ctx.fill(),this.ctx.restore()):(this.ctx.save(),this.ctx.fillStyle=this.color,this.ctx.beginPath(),this.ctx.arc(e,t,n,0,Math.PI*2),this.ctx.fill(),this.ctx.restore())}startStrokeAtUV(e,t){this.prevUV=e.clone(),this.prevPoint=t?t.clone():null,this.strokeStartUV=e.clone();const n=e.x*this.textureSize,i=(1-e.y)*this.textureSize;this.pointsBuffer=[{x:n,y:i}],this.tool==="pen"?(this.drawSoftDot(n,i,this.lineWidth*.9),this.drawingTexture.needsUpdate=!0):this.tool.startsWith("wedge-")&&this.stampWedgeAtUV(this.tool,e,this.lineWidth*2.5)}paintAtUV(e,t){if(!this.prevUV){this.prevUV=e.clone(),this.prevPoint=t?t.clone():null;const h=e.x*this.textureSize,u=(1-e.y)*this.textureSize;this.pointsBuffer=[{x:h,y:u}];return}const n=this.prevUV.x*this.textureSize,i=(1-this.prevUV.y)*this.textureSize,s=e.x*this.textureSize,a=(1-e.y)*this.textureSize,o=Math.hypot(s-n,a-i);if(o<.5)return;let c=o>75;if(t&&this.prevPoint&&t.distanceTo(this.prevPoint)>.35&&(c=!0),c){this.prevUV=e.clone(),this.prevPoint=t?t.clone():null,this.pointsBuffer=[{x:s,y:a}],this.tool==="pen"&&(this.drawSoftDot(s,a,this.lineWidth*.9),this.drawingTexture.needsUpdate=!0);return}if(this.pointsBuffer.push({x:s,y:a}),this.tool==="eraser")this.ctx.save(),this.ctx.globalCompositeOperation="destination-out",this.ctx.strokeStyle="rgba(0,0,0,1)",this.ctx.lineWidth=this.lineWidth*3.5,this.ctx.lineCap="round",this.ctx.lineJoin="round",this.ctx.beginPath(),this.ctx.moveTo(n,i),this.ctx.lineTo(s,a),this.ctx.stroke(),this.ctx.restore();else if(this.tool==="pen")if(this.pointsBuffer.length>=3){const h=this.pointsBuffer[this.pointsBuffer.length-3],u=this.pointsBuffer[this.pointsBuffer.length-2],d=this.pointsBuffer[this.pointsBuffer.length-1];this.drawSoftCurve(h,u,d)}else this.drawSoftSegment(n,i,s,a);this.prevUV=e.clone(),this.prevPoint=t?t.clone():null,this.drawingTexture.needsUpdate=!0}stampWedgeAtUV(e,t,n){const i=t.x*this.textureSize,s=(1-t.y)*this.textureSize,a=()=>{if(this.ctx.beginPath(),e==="wedge-h"){const o=n*3.2,l=n*1.4;this.ctx.moveTo(i,s),this.ctx.lineTo(i+l*.8,s-l*.5),this.ctx.lineTo(i+o,s),this.ctx.lineTo(i+l*.8,s+l*.5),this.ctx.closePath()}else if(e==="wedge-v"){const o=n*3.5,l=n*1.4;this.ctx.moveTo(i,s),this.ctx.lineTo(i-l*.5,s+l*.8),this.ctx.lineTo(i,s+o),this.ctx.lineTo(i+l*.5,s+l*.8),this.ctx.closePath()}else if(e==="wedge-w"){const o=n*2;this.ctx.moveTo(i,s),this.ctx.lineTo(i+o*.8,s-o*.4),this.ctx.lineTo(i+o*.35,s+o*.35),this.ctx.lineTo(i-o*.4,s+o*.8),this.ctx.closePath()}};this.softness>.05&&(this.ctx.save(),this.ctx.globalCompositeOperation="source-over",this.ctx.fillStyle=this.color,this.ctx.globalAlpha=.3*this.softness,this.ctx.shadowBlur=n*(1.8*this.softness),this.ctx.shadowColor=this.color,a(),this.ctx.fill(),this.ctx.restore()),this.ctx.save(),this.ctx.globalCompositeOperation="source-over",this.ctx.fillStyle=this.color,this.ctx.globalAlpha=.92,this.softness>.05&&(this.ctx.shadowBlur=n*(.6*this.softness),this.ctx.shadowColor=this.color),a(),this.ctx.fill(),this.ctx.restore(),this.drawingTexture.needsUpdate=!0}exportTexturePNG(){const e=document.createElement("a");e.href=this.drawingCanvas.toDataURL("image/png"),e.download=`Cuneiform_3D_Surface_Drawing_${Date.now()}.png`,e.click()}exportSVG(){const e=this.drawingCanvas.toDataURL("image/png"),t=`<?xml version="1.0" encoding="UTF-8"?>
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${this.textureSize} ${this.textureSize}" width="${this.textureSize}" height="${this.textureSize}">
  ...
  <image href="${e}" x="0" y="0" width="${this.textureSize}" height="${this.textureSize}" />
    ...
    `),this.toolbarEl=document.getElementById("drawing-toolbar")}updateDimensionsBadge(e){const t=document.getElementById("model-dimension-badge");t&&e&&(t.innerText=`📐 أبعاد المجسم: ${e.width} × ${e.height} × ${e.depth} سم`,t.style.display="inline-block")}open(){this.isOpen=!0,this.toolbarEl.classList.remove("hidden"),this.painter.setActive(!0),this.painter.modelDimensions&&this.updateDimensionsBadge(this.painter.modelDimensions);const e=document.getElementById("mob-drawing-btn");e&&e.classList.add("active");const t=document.getElementById("open-drawing-btn");t&&t.classList.add("active")}close(){this.isOpen=!1,this.toolbarEl.classList.add("hidden"),this.painter.setActive(!1);const e=document.getElementById("mob-drawing-btn");e&&e.classList.remove("active");const t=document.getElementById("open-drawing-btn");t&&t.classList.remove("active")}bindEvents(){document.getElementById("close-drawing-btn").addEventListener("click",()=>{this.close()}),this.toolbarEl.querySelectorAll(".tb-tool-btn").forEach(s=>{s.addEventListener("click",()=>{this.toolbarEl.querySelectorAll(".tb-tool-btn").forEach(o=>o.classList.remove("active")),s.classList.add("active");const a=s.getAttribute("data-tool");this.painter.setTool(a)})}),this.toolbarEl.querySelectorAll(".color-chip").forEach(s=>{s.addEventListener("click",()=>{this.toolbarEl.querySelectorAll(".color-chip").forEach(o=>o.classList.remove("active")),s.classList.add("active");const a=s.getAttribute("data-color");this.painter.setColor(a)})}),document.getElementById("draw-line-width").addEventListener("input",s=>{const a=parseInt(s.target.value,10);document.getElementById("line-width-val").innerText=a,this.painter.setLineWidth(a)});const t=document.getElementById("draw-softness");t&&t.addEventListener("input",s=>{const a=parseInt(s.target.value,10),o=document.getElementById("draw-softness-val");o&&(o.innerText=a),this.painter.setSoftness(a/100)}),document.getElementById("draw-opacity").addEventListener("input",s=>{const a=parseFloat(s.target.value);document.getElementById("layer-opacity-val").innerText=Math.round(a*100),this.painter.setOpacity(a)});const i=document.getElementById("lock-camera-btn");i.addEventListener("click",()=>{const s=!this.painter.cameraLocked;this.painter.setCameraLock(s),i.classList.toggle("active",s),i.querySelector(".icon").innerText=s?"🔒":"🔓",i.querySelector(".label").innerText=s?"الكاميرا مقفلة للرسم":"الكاميرا حرة للتدوير"}),document.getElementById("draw-undo-btn").addEventListener("click",()=>this.painter.undo()),document.getElementById("draw-clear-btn").addEventListener("click",()=>{confirm("هل ترغب في مسح طبقة الرسم ثلاثية الأبعاد بالكامل؟")&&this.painter.clear()}),document.getElementById("export-svg-btn").addEventListener("click",()=>{this.painter.exportSVG()}),document.getElementById("export-png-btn").addEventListener("click",()=>{this.painter.exportTexturePNG()}),document.getElementById("export-merged-btn").addEventListener("click",()=>{this.viewer.takeSnapshot()}),window.addEventListener("keydown",s=>{this.isOpen&&(s.ctrlKey||s.metaKey)&&s.key.toLowerCase()==="z"&&this.painter.undo()})}}class X0{constructor(e,t){this.container=e,this.viewer=t,this.active=!1,this.zoomLevel=2.8,this.loupeRadius=90,this.initDOM(),this.bindEvents()}initDOM(){this.container.insertAdjacentHTML("beforeend",`
